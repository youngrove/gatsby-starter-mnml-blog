...
declare namespace GatsbyTypes {
  ...
  type TagListQueryVariables = Exact<{
    tag: ReadonlyArray<Maybe<Scalars["String"]>> | Maybe<Scalars["String"]>;
  }>;
  ...
  type TagListQuery = {
    ...
    readonly allMdx: {
      readonly edges: ReadonlyArray<{
        readonly node: Pick<Mdx, "excerpt"> & {
  ...
  type TagsQuery = {
    readonly allMdx: {
      readonly edges: ReadonlyArray<{
        readonly node: {
          readonly frontmatter: Maybe<Pick<MdxFrontmatter, "tags">>;
        };
      }>;
    };
  };
